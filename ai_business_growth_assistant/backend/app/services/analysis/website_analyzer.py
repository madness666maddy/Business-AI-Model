...
from app.schemas.analysis import normalize_url
from app.utils.seed_data import get_website_analysis
...
class WebsiteAnalyzer:
    def analyze(self, url: str, business_name: str | None = None) -> dict:
        normalized_url = normalize_url(url)
        analysis = get_website_analysis()
        analysis["url"] = normalized_url
        analysis["subtitle"] = f"Technical SEO and conversion readiness snapshot for {business_name or urlparse(normalized_url).netloc}"
        ...
        try:
            ...
            analysis["contactSignals"] = contact_signals or analysis["contactSignals"]
            analysis["ctaFindings"] = cta_texts or analysis["ctaFindings"]
            analysis["serviceFindings"] = service_signals or analysis["serviceFindings"]
